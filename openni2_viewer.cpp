...
//
        ...
        pcl::visualization::PointCloudColorHandlerCustom<PointType> blue(cloud_plane, 0, 0, 255);
        ...
        ec.setClusterTolerance (0.02); // 10cm
        ...
        cloud_viewer_->addPointCloud (cloud_cluster, "OpenNICloud");
